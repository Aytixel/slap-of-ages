...
TEST_TARGET=test_timer test_game test_socket test_window test_animation recupererDonnee stockerDonnee gestion_ressources test_building test_game_state test_character
